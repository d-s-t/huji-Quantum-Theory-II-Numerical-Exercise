\section{חישוב הפוטנציאל $V_{ee}$}
הפוטנציאל הנתון בתרגיל מחושב על ידי האינטגרל
$$
V_{ee}(r) = \frac{Z-1}{Z}\int d\mathbf{r}' \frac{\rho_(r')}{|\mathbf{r} - \mathbf{r}'|} 
$$
האינטגרל הזה הוא מרחבי, כאשר החישובים הנומרים שלנו מחשבים רק את החלק הרדיאל. 
בחלק זה נחשב את האינטגרל הזוויתי כדי להישאר עם אינטגרל רדיאלי שיתאים לקוד הנומרי.
\par
...
\begin{align*}
    ...
    &\quad\left( u = r^2 + r'^2 - 2rr'\cos\theta' \right) \\
    &= \frac{2\pi}{2 r r'} \int_{r^2 + r'^2 -2r r'}^{r^2 + r'^2 +2r r'} \frac{du}{\sqrt{u}} \\
    &= \frac{2\pi}{r r'} \left( \sqrt{r^2 + r'^2 + 2 r r'} - \sqrt{r^2 + r'^2 - 2 r r'} \right) \\
    &= \frac{2\pi}{r r'} \left( r + r' - |r - r'| \right) \\
    &= \frac{4\pi}{\max(r,r')} \\
\end{align*}

אז האינטגרל הרדיאלי שנחשב נומרית הוא
\begin{align*}
    V_{ee}(r) 
    &= 4\pi\frac{Z-1}{Z}\int_0^\infty dr' \frac{r'^2 \rho(r')}{\max(r,r')} \\
    &= \frac{Z-1}{Z}\int_0^\infty dr' \frac{\lambda_e(r')}{\max(r,r')}
\end{align*}

כאשר $\lambda_e(r) = 4\pi r^2\rho(r)$ היא הצפיפות הרדיאלית של האלקטרונים.